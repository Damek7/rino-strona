(function (root, factory) {
  ...
  const now = '2026-07-15T10:30:00+02:00'
  ...
  function seedState() {
    return {
      ...
      sessionUserId: null,
      users: [
        { id: 'client-ania', fullName: 'Ania Nowak', email: 'ania@demo.rinomove.pl', password: DEMO_PASSWORD, role: 'client', createdAt: now },
        { id: 'trainer-marek', fullName: 'Marek Kowalski', email: 'marek@demo.rinomove.pl', password: DEMO_PASSWORD, role: 'trainer', createdAt: now },
        { id: 'trainer-julia', fullName: 'Julia Nowak', email: 'julia@demo.rinomove.pl', password: DEMO_PASSWORD, role: 'trainer', createdAt: now },
        { id: 'trainer-pawel', fullName: 'Paweł Wrona', email: 'pawel@demo.rinomove.pl', password: DEMO_PASSWORD, role: 'trainer', createdAt: now },
        { id: 'trainer-anna', fullName: 'Anna Sowa', email: 'anna@demo.rinomove.pl', password: DEMO_PASSWORD, role: 'trainer', createdAt: now },
      ],
      trainerProfiles: [
      ...
      slots: [
        { id: 'slot-m-1', trainerId: 'trainer-marek', startsAt: '2026-07-16T09:00:00+02:00', endsAt: '2026-07-16T10:00:00+02:00', status: 'available' },
        { id: 'slot-m-2', trainerId: 'trainer-marek', startsAt: '2026-07-16T17:30:00+02:00', endsAt: '2026-07-16T18:30:00+02:00', status: 'available' },
        { id: 'slot-m-3', trainerId: 'trainer-marek', startsAt: '2026-07-18T10:00:00+02:00', endsAt: '2026-07-18T11:00:00+02:00', status: 'booked' },
        { id: 'slot-j-1', trainerId: 'trainer-julia', startsAt: '2026-07-17T16:00:00+02:00', endsAt: '2026-07-17T17:00:00+02:00', status: 'available' },
        { id: 'slot-p-1', trainerId: 'trainer-pawel', startsAt: '2026-07-17T18:30:00+02:00', endsAt: '2026-07-17T19:30:00+02:00', status: 'available' },
        { id: 'slot-a-1', trainerId: 'trainer-anna', startsAt: '2026-07-18T12:00:00+02:00', endsAt: '2026-07-18T13:00:00+02:00', status: 'available' },
      ],
      bookings: [
        { id: 'booking-upcoming', clientId: 'client-ania', trainerId: 'trainer-marek', slotId: 'slot-m-3', status: 'confirmed', paymentStatus: 'paid', price: 22000, platformFee: 2200, location: 'Korty Legia, Warszawa', createdAt: '2026-07-12T12:00:00+02:00' },
        { id: 'booking-completed', clientId: 'client-ania', trainerId: 'trainer-marek', slotId: null, startsAt: '2026-07-10T18:00:00+02:00', endsAt: '2026-07-10T19:00:00+02:00', status: 'completed', paymentStatus: 'paid', price: 22000, platformFee: 2200, location: 'Korty Legia, Warszawa', createdAt: '2026-07-08T12:00:00+02:00' },
      ],
      conversations: [
        { id: 'conversation-1', bookingId: 'booking-upcoming', memberIds: ['client-ania', 'trainer-marek'], createdAt: '2026-07-12T12:01:00+02:00' },
      ],
      messages: [
        { id: 'message-1', conversationId: 'conversation-1', senderId: 'trainer-marek', body: 'Cześć Aniu! Kort 3 przy Myśliwieckiej będzie gotowy. Do zobaczenia!', createdAt: '2026-07-15T10:24:00+02:00' },
        { id: 'message-2', conversationId: 'conversation-1', senderId: 'client-ania', body: 'Super, będę 10 minut wcześniej.', createdAt: '2026-07-15T10:27:00+02:00' },
      ],
      preferences: [
  ...
  function createDemoStore(storage = globalThis.localStorage) {
    ...
    if (!state || state.version !== 1) state = seedState()
    ...
    const trainerDto = profile => {
      ...
      return { id: profile.userId, name: user.fullName, email: user.email, ...clone(profile) }
    }
    const bookingDto = booking => {
      ...
      return { ...clone(booking), startsAt: booking.startsAt || slot?.startsAt, endsAt: booking.endsAt || slot?.endsAt, trainerName: trainer?.fullName, clientName: client?.fullName }
    }
    ...
    async function listConversations() {
      ...
      return clone(state.conversations.filter(item => item.memberIds.includes(user.id)).map(item => {
        ...
        return { ...item, other: publicUser(other), lastMessage: messages.at(-1) || null }
      }))
    }
    ...
    return {
      ...
      listBookings, updateBookingStatus, listConversations, listMessages, sendMessage, setAvailability,
      getEarnings, getPreferences, savePreferences, saveTrainerProfile, listClients, createReview, reset,
    }
  }
