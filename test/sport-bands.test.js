...
test('sport bands contain approved copy and destinations', () => {
  assert.match(html, /Od pierwszego odbicia do pewnej gry na korcie\./)
  assert.match(html, /Poznaj zasady, złap rytm i wejdź do gry\./)
  assert.match(html, /Technika i intensywność dopasowane do Twojego poziomu\./)
  assert.match(html, /Spokojny start, lepszy swing i więcej pewności\./)
